import { Directive, Input, HostBinding, Renderer2, EventEmitter, Output, AfterContentInit, OnDestroy, PLATFORM_ID, ElementRef, Inject } from '@angular/core';
...
export class ImagePreloadDirective implements AfterContentInit, OnDestroy {
